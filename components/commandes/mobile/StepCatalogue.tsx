...
import { Search, ShoppingCart, ChevronLeft, Plus, Check } from 'lucide-react';
import { Client, Category, calculateArticlePrice, getProductStateStyle, PACK_TYPES } from '@/types';
...
export default function StepCatalogue({
  client, categories, articles, lines, onAdd, onBack, onOpenCart,
}: Props) {
