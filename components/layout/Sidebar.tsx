...
const NAV_STRUCTURE: NavEntry[] = [
  ...
  { type: 'group', label: 'Achat', icon: ShoppingCart, items: [
    { name: 'Mercuriale',    href: '/achat',                  icon: TrendingUp,     module: 'stock' },
    { name: 'Commandes',     href: '/achat/bons-commande',    icon: ListOrdered,    module: 'stock' },
    { name: 'Factures',      href: '/achat/factures',         icon: Receipt,        module: 'stock' },
    { name: 'Fournisseurs',  href: '/achat/fournisseurs',     icon: Building2,      module: 'stock' },
  ]},
  { type: 'group', label: 'Stock', icon: Warehouse, items: [
    { name: 'Stock',         href: '/stock',                  icon: Warehouse,      module: 'stock' },
    { name: 'Articles MP',   href: '/stock/articles',         icon: Package,        module: 'stock' },
    { name: 'Produits finis', href: '/stock/produits-finis',  icon: ShoppingBag,    module: 'stock' },
  ...
  { type: 'group', label: 'Recettes', icon: ChefHat, items: [
    { name: 'Recettes valorisées', href: '/recettes',           icon: ChefHat,    module: 'recettes' },
    { name: 'Fiches recettes',     href: '/recettes/fiches',    icon: BookOpen,   module: 'recettes' },
    { name: 'Catalogue coûté',     href: '/recettes/catalogue', icon: Layers,     module: 'recettes' },
  ]},
